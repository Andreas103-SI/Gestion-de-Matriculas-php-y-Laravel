...
@section('content')
    ...
    <form action="{{ route('students.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="dni_nie" id="dni_nie" class="form-control" value="{{ old('dni_nie') }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="checkbox" name="disability" id="disability" class="form-check-input" value="1" {{ old('disability') ? 'checked' : '' }}>
